...
public class Solver
{
    ...
    private static double[] CalculateSolution(Line[] lines, int numberOfColumns)
    {
        ...
        for (; index < lines.Length; index++)
        {
            ...
            if (line[numberOfColumns] != 0) columnsLeft++;
        }
        ...
        if (columnsLeft > 0) throw new NoSolutionException("The system of equations cannot be solved");
        return solution;
    }
}